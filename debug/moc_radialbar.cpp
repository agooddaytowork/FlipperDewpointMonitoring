...
void RadialBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RadialBar *_t = static_cast<RadialBar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::sizeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::startAngleChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::spanAngleChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::minValueChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::maxValueChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::valueChanged)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::dialWidthChanged)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::backgroundColorChanged)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::foregroundColorChanged)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::progressColorChanged)) {
                *result = 9;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::textColorChanged)) {
                *result = 10;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::suffixTextChanged)) {
                *result = 11;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::penStyleChanged)) {
                *result = 12;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::dialTypeChanged)) {
                *result = 13;
                return;
            }
        }
        {
            typedef void (RadialBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadialBar::textFontChanged)) {
                *result = 14;
                return;
            }
        }
...
const QMetaObject RadialBar::staticMetaObject = {
    { &QQuickPaintedItem::staticMetaObject, qt_meta_stringdata_RadialBar.data,
      qt_meta_data_RadialBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RadialBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RadialBar.stringdata0))
        return static_cast<void*>(const_cast< RadialBar*>(this));
